...
def loop():
    ...
    for episode in range(MAX_EPISODES):
        ...
        while True:
            ...
            # RL learn from this transition (s, a, r, s_, a_) ==> Sarsa(lambda)
            brain.learn_advanced(str(observation), action, reward, str(observation_), action_)
